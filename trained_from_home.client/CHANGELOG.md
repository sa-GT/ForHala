...
- Create Angular project with ng: `ng new trained_from_home.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`trained_from_home.client.esproj`).
